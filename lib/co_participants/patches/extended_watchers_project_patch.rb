...
unless Project.singleton_class.included_modules.include?(CoParticipants::Patches::ExtendedWatchersProjectPatch)
   Project.singleton_class.send(:prepend, CoParticipants::Patches::ExtendedWatchersProjectPatch)
end
